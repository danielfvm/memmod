...
class MainWindow(Gtk.ApplicationWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.builder.add_from_file('/home/daniel/Projects/memtool.ui')
        self.main_window = self.builder.get_object('MainWindow')
        self.main_window.set_title("test")
        self.main_window.show()
        self.view = self.builder.get_object('view')

        self.builder.get_object('button-process').connect("clicked", self.show_dialog_process)

        self.builder.get_object('process-select-titlebar-cancel').connect("clicked", self.hide_dialog_process)
        self.builder.get_object('process-select-titlebar-open').connect("clicked", self.open_dialog_process)
        self.dialog_process_select = self.builder.get_object('process-select')
    ...
    def open_dialog_process(self, _):
        print("open")

    def hide_dialog_process(self, _):
        self.dialog_process_select.hide()

    def show_dialog_process(self, _):
        self.dialog_process_select.show()
        listview = self.builder.get_object('process-select-list')
